...
if ( ! function_exists( 'wordpress_scripts' ) ) {
	...
	function wordpress_scripts() {
		...
		wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/assets/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js', array(), $the_theme->get( 'Version' ), true );
		wp_enqueue_script( 'scripts', get_template_directory_uri() . '/assets/js/theme.min.js', array(), $the_theme->get( 'Version' ), true );
	}
